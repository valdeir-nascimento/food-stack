...
public class CreateCategoryUseCase implements CommandHandler<CreateCategoryCommand, CreateCategoryOutput> {
    ...
    @Override
    public Result<CreateCategoryOutput> handle(final CreateCategoryCommand command) {
