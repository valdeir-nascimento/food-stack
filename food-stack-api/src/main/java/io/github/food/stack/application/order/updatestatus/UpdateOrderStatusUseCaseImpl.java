...
public class UpdateOrderStatusUseCaseImpl implements UpdateOrderStatusUseCase {
    ...
    public UpdateOrderStatusUseCaseImpl(final OrderGateway orderGateway) {
        this.orderGateway = Objects.requireNonNull(orderGateway);
    }

    @Override
    public Result<UpdateOrderStatusOutput> execute(final UpdateOrderStatusCommand command) {
