...
public class CreateRestaurantUseCase implements CommandHandler<CreateRestaurantCommand, CreateRestaurantOutput> {
    ...
    @Override
    public Result<CreateRestaurantOutput> handle(final CreateRestaurantCommand command) {
