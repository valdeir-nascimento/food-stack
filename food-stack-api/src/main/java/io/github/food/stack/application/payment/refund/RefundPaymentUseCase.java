...
public class RefundPaymentUseCase implements CommandHandler<RefundPaymentCommand, RefundPaymentOutput> {

    private final PaymentGateway paymentGateway;

    public RefundPaymentUseCase(final PaymentGateway paymentGateway) {
        this.paymentGateway = Objects.requireNonNull(paymentGateway);
    }

    @Override
    public Result<RefundPaymentOutput> handle(final RefundPaymentCommand command) {
