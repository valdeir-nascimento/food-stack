...
public class CreatePaymentUseCase implements CommandHandler<CreatePaymentCommand, CreatePaymentOutput> {

    private final PaymentGateway paymentGateway;

    public CreatePaymentUseCase(final PaymentGateway paymentGateway) {
        this.paymentGateway = Objects.requireNonNull(paymentGateway);
    }

    @Override
    public Result<CreatePaymentOutput> handle(final CreatePaymentCommand command) {
