...
public class UpdateRestaurantUseCaseImpl implements UpdateRestaurantUseCase {
    ...
    public UpdateRestaurantUseCaseImpl(final RestaurantGateway restaurantGateway) {
        this.restaurantGateway = Objects.requireNonNull(restaurantGateway);
    }

    @Override
    public Result<UpdateRestaurantOutput> execute(final UpdateRestaurantCommand command) {
